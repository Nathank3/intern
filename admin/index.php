...
<body> 
    <!-- heading -->
    <h1 class="uk-heading-line uk-text-center"><span style="color:teal; font-weight:700;">MAKUENI COUNTY ASSEMBLY</span></h1>
    <!-- form -->
   <div class="main-bg">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="wrap-login100">
                        ...
                        <form class="login100-form validate-form p-l-55 p-r-55 p-t-20" action="verify.php" method="post">
